...
public class Transactions
{
    ...
    // Get information about the payment type - Jomat
    ...
    // creation of the username by the customer online - Jomat
...
//            ps.setInt(4, quantity);
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            ResultSet dbResult = Transactions.searchItem(category, title, singer, quantity);
            dbResult.toString();
